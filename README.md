...
<table>
  ...
  <tr>
    ...
    <td>Busca específica</td>
    <td>Site empresa</td>
    <td>Escreva "site:concert.com.br" no campo de busca e aperte "Enter".</td>
    <td>O primeiro link será o site "concert.com.br".</td>
    <td>Ok</td>
  </tr>
  </table>
